<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('bouquet.orders.store') }}" method="POST" id="orderForm">
                        @csrf
                        ...
                        <div class="mb-4">
                            <label for="customer_name" class="block text-sm font-medium text-gray-700">Nama Customer <span class="text-red-500">*</span></label>
                            <input type="text" name="customer_name" id="customer_name" class="form-input w-full rounded-md border-gray-300" value="{{ old('customer_name') }}" required>
                            @error('customer_name')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            <label for="wa_number" class="block text-sm font-medium text-gray-700">Nomor WhatsApp <span class="text-red-500">*</span></label>
                            <input type="text" name="wa_number" id="wa_number" class="form-input w-full rounded-md border-gray-300" value="{{ old('wa_number') }}" required placeholder="08xxxxxxxxxx">
                            @error('wa_number')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Item Buket -->
                        <div class="mb-6">
                            <h3 class="text-lg font-medium text-gray-900">Item Buket</h3>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('bouquet.orders.index') }}" class="bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded mr-2">
                                Cancel
                            </a>
                            <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
                                Create Bouquet Order
                            </button>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        document.getElementById('orderForm').onsubmit = function() {
            if (orderItems.length === 0) {
                alert('Tambahkan minimal 1 item buket sebelum membuat pesanan!');
                return false;
            }
