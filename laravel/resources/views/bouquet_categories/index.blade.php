<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('bouquet-categories.create') }}" class="bg-pink-600 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded">Tambah Kategori</a>
        </div>
    </x-slot>
    <div class="py-8">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 transition-all">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 border text-sm font-medium space-x-2">
                                        <a href="{{ route('bouquet-categories.edit', $category) }}" class="text-green-600 hover:text-green-900">Ubah</a>
                                        <form action="{{ route('bouquet-categories.destroy', $category) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="px-4 py-2 border text-center text-gray-500">Tidak ada kategori ditemukan</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
