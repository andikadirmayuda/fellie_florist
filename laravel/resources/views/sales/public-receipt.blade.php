...
<head>
    ...
    <title>Struk Digital - {{ $sale->order_number }} | Fellie Florist</title>

    <!-- Meta Tags for Social Sharing -->
    <meta name="description"
        content="Struk digital pembelian {{ $sale->order_number }} dari Fellie Florist - Total: Rp {{ number_format($sale->total, 0, ',', '.') }}">
    <meta property="og:title" content="Struk Digital - {{ $sale->order_number }}">
    <meta property="og:description" content="Bukti pembelian digital dari Fellie Florist">
    <meta property="og:image" content="{{ asset('logo-fellie.png') }}">
    <meta property="og:type" content="website">

    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('logo-fellie.png') }}">
            ...
            <div class="px-4 sm:px-6 py-6 text-center border-t border-gray-200 bg-gray-50">
                <div class="space-y-4">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-sm text-gray-600">Telah berbelanja di Fellie Florist</p>
                    </div>
