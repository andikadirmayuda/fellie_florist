...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Struk penjualan {{ $sale->order_number }} dari Fellie Florist">
    <meta property="og:title" content="Struk Digital - {{ $sale->order_number }}">
    <meta property="og:description" content="Bukti penjualan dari Fellie Florist">
