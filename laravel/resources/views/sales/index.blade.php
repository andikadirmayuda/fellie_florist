                                    ...
                                    @forelse($sales as $sale)
                                        <tr class="hover:bg-pink-25 transition-colors duration-150">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-semibold text-gray-900">{{ $sale->order_number }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        ...
                                        <tr>
                                            <td colspan="6" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada transaksi
                                                    </h3>
                                    ...
                                    <div class="p-4 hover:bg-pink-25 transition-colors duration-150">
                                        ...
                                        <div class="flex items-center justify-between mb-3">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <p class="text-sm font-semibold text-gray-900">{{ $sale->order_number }}
                                                    </p>
