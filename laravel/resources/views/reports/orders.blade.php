                    ...
                    <div class="flex items-center justify-between mb-1">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 text-sm">Riwayat pesanan dari pelanggan online pada periode yang dipilih</p>
                            </div>
                        </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-xs text-gray-500">
                                                {{ $order->created_at ? \Carbon\Carbon::parse($order->created_at)->format('H:i') : '' }} WIB
                                            </span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex flex-col">
                                            ...
                                            @if($order->delivery_fee > 0)
                                                <span class="text-xs text-gray-500">+Ongkir: Rp{{ number_format($order->delivery_fee,0,',','.') }}</span>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
