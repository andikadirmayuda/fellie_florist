    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-gray-900 text-xl mb-2">Sales Overview</div>
                        <p class="text-gray-600">View sales reports and analytics</p>
                        <div class="mt-4">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-gray-900 text-xl mb-2">System Settings</div>
                        <p class="text-gray-600">Configure system settings</p>
                        <div class="mt-4">
                            <a href="#" class="text-blue-600 hover:text-blue-900">Manage Settings →</a>
                        </div>
                    </div>
                </div>
            </div>
