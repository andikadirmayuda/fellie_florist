<x-app-layout>
    ...
    <x-slot name="head">
        ...
        <style>
            body,
            .font-sans {
                font-family: 'Figtree', theme('fontFamily.sans'), sans-serif;
            }
        </style>
    </x-slot>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                <div class="bg-white rounded-sm shadow-lg flex flex-col p-8 border border-gray-100">
                    <h3 class="font-semibold text-lg text-black mb-6 flex items-center"><i
                            class="bi bi-graph-up-arrow mr-2 text-black/60"></i> Sales Performance</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                <div class="lg:col-span-2 bg-white shadow-lg rounded-sm p-8 mb-6 lg:mb-0 border border-gray-100">
                    <h3 class="font-semibold text-lg text-black mb-4 flex items-center"><i
                            class="bi bi-bell mr-2 text-black/60"></i> Notifikasi</h3>
                    <ul class="space-y-2">
                ...
                <div class="bg-white shadow-lg rounded-sm p-8 flex flex-col justify-between border border-gray-100">
                    <h3 class="font-semibold text-lg text-black mb-4 flex items-center"><i
                            class="bi bi-lightning-charge mr-2 text-black/60"></i> Aksi Cepat</h3>
            ...
            <div class="bg-white rounded-sm shadow-lg p-8 border border-gray-100">
                <h3 class="font-semibold text-lg text-black mb-4 flex items-center"><i
                        class="bi bi-flower2 mr-2 text-black/60"></i> Bunga Ready Stock
                </h3>
                <div class="mb-4 text-sm text-blue-700">
                    <strong>Informasi Bunga Ready Stock (Publik):</strong><br>
                    <a href="{{ url('/product-fellie') }}" target="_blank"
                        class="underline text-blue-700 hover:text-blue-900">{{ url('/product-fellie') }}</a>
                    <span class="block text-xs text-gray-400">(Link ini dapat dibagikan ke pelanggan, dapat diakses
                        tanpa login)</span>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm text-left">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-4 py-2 text-black text-center">Tidak ada produk ready stock.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
