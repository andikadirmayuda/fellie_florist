                    ...
                    <div class="mb-6">
                        <form action="{{ route('inventory.index') }}" method="GET" class="flex gap-4 items-end">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <x-input-label for="low_stock" :value="__('Low Stock Only')" />
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('inventory.history', $product) }}" 
                                           class="text-indigo-600 hover:text-indigo-900 mr-3">History</a>
                                        <a href="{{ route('inventory.adjust-form', $product) }}" 
                                           class="text-green-600 hover:text-green-900">Adjust</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
