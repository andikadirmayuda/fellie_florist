                    ...
                    <nav class="flex items-center justify-center">
                        <div class="flex items-center justify-center space-x-2 sm:space-x-4 md:space-x-8">
                            ...
                            <a href="{{ route('public.bouquets') }}"
                                class="px-2 sm:px-4 py-1.5 text-center {{ $activeTab === 'bouquets' ? 'nav-tab nav-hover-effect group relative items-center space-x-2 px-3 py-2 rounded-xl transition-all duration-300 bg-gradient-to-r from-rose-500 to-red-500 text-white shadow-lg nav-active-gradient' : '' }}">
                    ...
                    <div class="bouquet-card group" data-name="{{ strtolower($bouquet->name) }}"
                        ...
                        <div
                            ...
                            <div class="flex-1 flex flex-col">
                                ...
                                <!-- Sizes -->
                                <div class="mb-3">
                                    <span class="text-xs text-gray-500 text-center block mb-2">Ukuran
                                        Tersedia:</span>
