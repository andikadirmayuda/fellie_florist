...
<head>
    ...
    <title>Invoice Pemesanan - {{ $order->customer_name }} | Fellie Florist</title>

    <!-- Meta Tags for Social Sharing -->
    <meta name="description" content="Invoice pemesanan {{ $order->customer_name }} dari Fellie Florist">
    <meta property="og:title" content="Invoice Pemesanan - Fellie Florist">
    <meta property="og:description" content="Invoice pemesanan digital dari Fellie Florist">
    <meta property="og:image" content="{{ asset('logo-fellie-02.png') }}">
    <meta property="og:type" content="website">

    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('logo-fellie-02.png') }}">
        ...
        <div class="print-container bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-pink-50 via-rose-50 to-pink-50 px-6 py-8 text-center border-b border-pink-100">
                <div class="flex justify-center mb-4">
                    <img src="{{ asset('logo-fellie-02.png') }}" alt="Fellie Florist Logo"
                        class="h-20 w-20 object-cover rounded-full border-2 border-pink-200 shadow-sm">
                </div>
                <h1 class="text-2xl font-bold text-gray-900 mb-2">Fellie Florist</h1>
                ...
                <div class="text-sm text-gray-600 leading-relaxed">
                    ...
                    <p class="mt-2">
                        ...
                        <i class="bi bi-instagram ml-2 mr-1"></i>@fellieflorist
                    </p>
                </div>
                    ...
                    <div class="p-4 bg-white rounded-lg shadow-sm border border-pink-100">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 text-center sm:text-left">
                            <div class="flex items-center justify-center sm:justify-start">
                                ...
                                <span class="text-base sm:text-lg font-semibold text-gray-700">Total Pesanan</span>
                            </div>
            ...
            <div class="px-4 sm:px-6 py-6 text-center border-t border-gray-200 bg-gray-50">
                <div class="space-y-4">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-sm text-gray-600">Telah mempercayai Fellie Florist untuk pesanan Anda</p>
                    </div>
                    ...
                    <div class="text-sm text-gray-600 space-y-2">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
                            ...
                            <a href="https://instagram.com/fellieflorist" target="_blank"
                                class="inline-flex items-center text-pink-600 hover:text-pink-700">
                                <i class="bi bi-instagram mr-1"></i>@fellieflorist
                            </a>
                        </div>
                    </div>
